  ...
  return (
    <div className="h-full w-full overflow-y-auto bg-background text-on-background py-8 px-margin-mobile md:px-margin-desktop">
      <div className="max-w-[1100px] mx-auto space-y-12">
        ...
        <section id="local-support" className="bg-surface-variant p-5 sm:p-8 rounded-3xl md:rounded-[3rem] space-y-6 sm:space-y-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <form onSubmit={handleSearchLocation} className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full md:w-auto">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex-1 sm:flex-none justify-center bg-primary text-on-primary px-6 py-3 rounded-xl font-bold hover:opacity-90 active:scale-95 transition-all text-sm shrink-0 flex items-center gap-2"
                >
        ...
        {showDeleteConfirm !== null && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-md p-4 animate-fade-in">
            <div className="bg-surface rounded-3xl p-6 sm:p-8 max-w-[420px] w-full shadow-2xl border border-outline-variant/20 text-center space-y-6 animate-[scaleIn_0.2s_ease-out]">
              <div className="flex flex-col items-center justify-center space-y-3">
                ...
                <div className="space-y-2">
                  <h3 className="font-bold text-on-surface text-xl">Remove Contact?</h3>
              ...
              <div className="flex sm:flex-row flex-col gap-3 w-full">
                <button
                  ...
                  className="flex-1 border border-outline-variant/30 text-on-surface font-semibold py-3 px-4 rounded-xl text-sm hover:bg-surface-container transition-colors cursor-pointer"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 bg-error text-white font-semibold py-3 px-4 rounded-xl text-sm hover:bg-error/90 transition-all shadow-md active:scale-95 cursor-pointer"
                >
                  Remove
                </button>
              </div>
