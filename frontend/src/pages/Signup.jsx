...
function getPasswordStrength(password) {
  ...
  const levels = [
    { score: 0, label: '', color: '' },
    { score: 1, label: 'Weak', color: '#ba1a1a' },
    { score: 2, label: 'Fair', color: '#f59e0b' },
    { score: 3, label: 'Good', color: '#0059ba' },
    { score: 4, label: 'Strong', color: '#006c47' },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-background text-on-background">
      ...
      <div className="hidden lg:flex lg:w-[52%] relative overflow-hidden">
        <img
          src="/signup-side.png"
          alt="Sunrise yoga wellness scene"
      ...
      <div className="flex-1 flex flex-col justify-center items-center min-h-screen bg-surface-container-lowest px-6 py-16 sm:px-10 md:px-16 relative overflow-hidden">
        ...
        <div className="w-full max-w-[420px] space-y-6 animate-slide-up">
          <div className="space-y-2">
            ...
            <p className="text-on-surface-variant text-sm">No credit card required. Free 14-day trial.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <span className="material-symbols-outlined auth-input-icon text-[18px]">person</span>
                <input
                  required
                  id="name"
                  type="text"
                  ...
                  <div className="flex gap-1">
                    {[1, 2, 3, 4].map(i => (
                      <div
                        ...
                        style={{
                          backgroundColor: i <= strength.score ? strength.color : '#e6eeff',
                        }}
                      />
                    ))}
                  </div>
                    ...
                    <p className="text-xs font-medium" style={{ color: strength.color }}>
                      ...
                      {strength.score < 4 && (
                        <span className="text-on-surface-variant font-normal ml-1">
                          — {strength.score < 2 ? 'add uppercase & numbers' : strength.score < 3 ? 'add a symbol' : 'looks great!'}
                        </span>
                      )}
                    </p>
                  )}
            ...
            <div className="flex items-start gap-2.5 pt-1">
              <input
                ...
                className="w-4 h-4 rounded border-outline-variant accent-primary cursor-pointer mt-0.5 flex-shrink-0"
              />
