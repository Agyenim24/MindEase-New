    ...
    <div className="min-h-screen bg-background text-on-background flex flex-col md:flex-row">
        ...
        <div className="my-auto relative z-10 max-w-lg space-y-8">
          <div className="space-y-4">
            ...
            <h2 className="font-headline-xl text-headline-xl text-on-surface leading-tight">
              Begin your path to a calmer mind today.
            </h2>
            <p className="font-body-lg text-body-lg text-on-surface-variant">
              Create an account to track your moods, learn clinical coping methods, and access 24/7 empathetic support.
            </p>
          </div>

          {/* Testimonial / Features Card */}
          <div className="bg-surface-container-lowest/80 backdrop-blur-xl border border-outline-variant/30 rounded-3xl p-6 shadow-xl card-shadow">
            ...
            <ul className="space-y-2.5">
              <li className="flex items-center gap-2 font-body-md text-body-md text-on-surface-variant">
                ...
                24/7 Clinical-Grade AI Support
              </li>
              <li className="flex items-center gap-2 font-body-md text-body-md text-on-surface-variant">
                <span className="material-symbols-outlined text-secondary text-sm font-bold">check</span>
                15+ Mindfulness &amp; CBT Exercises
              </li>
              <li className="flex items-center gap-2 font-body-md text-body-md text-on-surface-variant">
                <span className="material-symbols-outlined text-secondary text-sm font-bold">check</span>
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-12 md:p-16 lg:p-24 relative overflow-hidden bg-surface-container-lowest">
        ...
        <div className="md:hidden flex justify-between items-center absolute top-6 left-6 right-6">
          ...
          <Link to="/login" className="text-primary font-label-md text-label-md hover:underline">Login</Link>
        </div>

        <div className="max-w-md w-full mx-auto space-y-8 relative z-10">
          {/* Form Header */}
          <div className="space-y-2">
            <h3 className="font-headline-lg text-headline-lg font-bold text-on-surface">Create Account</h3>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {/* Name Field */}
            <div className="space-y-2">
              <label htmlFor="name" className="block font-label-md text-label-md text-on-surface font-medium">Full Name</label>
              <input 
                required
                id="name"
                type="text"
            ...
            <div className="flex items-start gap-2">
              <input 
                ...
                className="w-4.5 h-4.5 rounded border-outline-variant/60 text-primary focus:ring-primary/20 accent-primary cursor-pointer mt-0.5"
              />
              <label htmlFor="terms" className="font-label-md text-label-md text-on-surface-variant select-none cursor-pointer leading-normal">
